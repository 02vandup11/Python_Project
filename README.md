...
This repository showcases multiple beginner-friendly to intermediate Python projects including data analysis, utility tools, and small games.  
Each project demonstrates core Python skills such as problem-solving, data handling, visualization, and interactive applications.
...
- Sales insights by item type, outlet type, and location tier  
- Generates cleaned dataset and summary CSV  
...
# Author
Vandana Padhi  
Python • Data Analysis • Machine Learning • Streamlit • EDA • Visualization
